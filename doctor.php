...
<script src="js/docvalid.js"></script>
...
<form action="doccode.php" method="post"   enctype="multipart/form-data">
<div class="row">
...
<div class="col-sm-3"><input type="text" name="name" placeholder="Enter Your Name" onblur="checkNameField(this)" id="name" class="form-control" required/></div>
<div class="col-sm-2 h4">FATHER'S NAME :</div>
<div class="col-sm-3"><input type="text" name="fname" placeholder="Enter Father's Name" id="fname" onblur="checkNameField(this)" class="form-control" required/></div>
<div class="col-sm-1"></div>
</div>
<br>
<div class="row">
...
<div class="col-sm-1 h4"><input type="radio" name="a" value="Male"  required />&nbsp; Male
 </div>
<div class="col-sm-2 h4"> 
<input type="radio" name="a" value="Female"  required />&nbsp; Female</div>
 
<div class="col-sm-2 h4">EMAIL ID :</div>
<div class="col-sm-3"><input type="text" name="email" placeholder="Enter Email Id" onblur="checkEmail(this)"  class="form-control" required/></div>
<div class="col-sm-1"></div>
</div>
<br>
...
<div class="col-sm-3"><input type="text" name="password" placeholder="Enter Your Password" class="form-control" required/>
 </div>
 
 
<div class="col-sm-2 h4">FEES :</div>
<div class="col-sm-3"><input type="text" name="fees" placeholder="Enter Your Fees(in rupees)" maxlength="8" onblur="checkFeesField(this)" class="form-control" required/></div>
<div class="col-sm-1"></div>
</div>
...
<div class="row">
<div class="col-sm-1"></div>
<div class="col-sm-2 h4">TIMING :</div>
<div class="col-sm-3"><input type="text" name="time" placeholder="Enter Your Timing" class="form-control"  required/>
 </div>
 
 
<div class="col-sm-2 h4">SPECIALITY :</div>
<div class="col-sm-3">
...
<div class="col-sm-3">
<textarea placeholder="Enter Your Address" style="resize:none" name="address" class="form-control" required></textarea></div>
<div class="col-sm-2 h4">MOBILE NO. :</div>
<div class="col-sm-3"><input type="text" name="mobile" placeholder="Enter Mobile Number"  onblur="checkMobileNumber(this)"
 maxlength="10" class="form-control"/></div>
<div class="col-sm-1"></div>
</div>
<br>
<div class="row">
...
<div class="col-sm-3"><input type="file" name="file" class="form-control" onchange="FileUpload(this)"  required/></div>
...
<div class="col-sm-1"></div>
<div class="col-sm-1"><input type="text" id="txtc2" class="form-control" style="text-align:left;" required/></div>
